...
public class ServletWebMyUtil
{
  ...
  {
    return getRequestBody(request, GlobalConstant.DEFAULT_CHARSET);
  }
  ...
  public static String getCharacterEncoding(HttpServletRequest request, String defaultCharset)
  {
    ...
    return StringUtils.defaultIfEmpty(charset, GlobalConstant.DEFAULT_CHARSET);
  }
