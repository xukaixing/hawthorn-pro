 ...
 * <p></p>
 * @remark: Spring WebFlux工具类
 * @author: andy.ten@tom.com
 * @date: 2020/10/31 8:10 下午
 * @version v1.0.1
 */
public class SpringWebFluxMyUtil
{
  /**
  ...
  {
    ServerResponse.Context context = new CustomServerResponseContext(SpringBeanMyUtil.getBean(ServerCodecConfigurer.class));
  ...
  public static boolean isAsyncRequest(ServerRequest request)
  {
    ...
    if (handler instanceof HandlerMethod)
    {
      ...
      if (!isAsync)
      {
        isAsync = ReactiveWebUtil.isAjaxRequest(request);
      }
    }
    return isAsync;
  }
