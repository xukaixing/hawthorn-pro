 ...
 * <p></p>
 * @remark: 定制的ObjectMapper，用来解决启用@JsonRootName注解配合SerializationFeature.WRAP_ROOT_VALUE及DeserializationFeature.UNWRAP_ROOT_VALUE特性时带来的一些列问题
 * <p>例如启用上述特性时:
 ...
 *    该定制的ObjectMapper才去动态判断序列化/反序列化对象上是否有@JsonRootName注解，来解决这个问题
 *  </p>
 * @author: andy.ten@tom.com
 * @date: 2020/10/31 3:14 下午
 * @version v1.0.1
 */
