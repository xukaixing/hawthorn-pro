package com.hawthorn.component.utils.security;
 ...
 * <p></p>
 * @remark: Servlet Web环境下的spring-security工具类
 * @author: andy.ten@tom.com
 * @date: 2020/10/31 7:54 下午
 * @version v1.0.1
 */
public class SpringSecurityUtil
{
  ...
  // {
  //   return SpringBeanUtil.getBean(WebSecurityConfigurerAdapter.class);
  // }
  //
  // /**
  ...
  //       if (primaryHttpSecurity == null)
  //       {
  //         Method method = ReflectionUtil.findMethod(WebSecurityConfigurerAdapter.class, "getHttp");
  //         method.setAccessible(true);
  //         primaryHttpSecurity = (HttpSecurity) ReflectionUtil.invokeMethod(method, primarySecurityConfigurer);
  //       }
  //     }
  //   }
