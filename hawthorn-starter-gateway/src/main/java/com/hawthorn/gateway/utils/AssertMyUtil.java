...
import com.hawthorn.gateway.exception.BizException;
...
public class AssertMyUtil extends Assert
{
  public AssertMyUtil()
  {
  }
  ...
  public static void isNull(Object object, BizCode bizCode, Object... params) throws IllegalArgumentException
  {
    ...
    {
      //throw new IllegalArgumentException(StrUtil.format(errorMsgTemplate, params));
      throw new BizException(bizCode.getCode(), assert_prefix + StringMyUtil.placeHolder(bizCode.getMsg(), params));
    }
  }
