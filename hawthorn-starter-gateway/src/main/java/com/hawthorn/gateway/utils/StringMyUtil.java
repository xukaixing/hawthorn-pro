package com.hawthorn.gateway.utils;
 ...
 * @version v1.0.1
 */
public class StringMyUtil extends StrUtil
{
  ...
  {
    AssertMyUtil.notNull(template, BizCode.METHOD_ARGS_NOTNULL, "template");
  ...
  {
    AssertMyUtil.notNull(underlineString, BizCode.METHOD_ARGS_NOTNULL, "underlineString");
  ...
  {
    AssertMyUtil.notNull(inputString, BizCode.METHOD_ARGS_NOTNULL, "inputString");
    StringBuilder sb = new StringBuilder();
