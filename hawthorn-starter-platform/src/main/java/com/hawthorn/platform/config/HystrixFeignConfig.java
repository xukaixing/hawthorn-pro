 ...
 *   Sleuth中的TraceFeignClientAutoConfiguration中的feignHystrixBuilder和本配置有冲突，只能使用配置文件方式设置参数
 *   结论：1. 去掉该类配置，在yml中进行配置与Sleuth中的feignHystrixBuilder的注册bean冲突
 *        2. 去掉feignHystrixBuilder构造函数
 * </p>
