 ...
 * <p></p>
 * @remark: Spring Bean工具类
 * @author: andy.ten@tom.com
 * @date: 2020/10/31 7:35 下午
 * @version v1.0.1
 */
@Slf4j
public class SpringBeanMyUtil
{
  ...
  {
    SpringBeanMyUtil.applicationContext = applicationContext;
  }
  ...
  {
    SpringBeanMyUtil.environment = environment;
  }
  ...
  public static <T> void registerBean(ApplicationContext applicationContext, String beanName, Class<T> beanClass, boolean singleton, Consumer<BeanDefinitionBuilder> beanCustomizer)
  {
    ...
    if (!StringMyUtil.isEmpty(beanName))
    {
  ...
  {
    setBeanProperty(bean, properties, ApplicationConstant.DEFAULT_CONVERSION_SERVICE.get());
  }
  ...
  {
    setBeanProperty(beans, properties, ApplicationConstant.DEFAULT_CONVERSION_SERVICE.get());
  }
}
